...
export EDITOR=subl
export PATH=$HOME/work/v11/tests/toolkit/utils:$HOME/work/investigate:$PATH
...
export CR_REMOTE_USER=superuser
export CR_CHALLENGE_HELPER=/usr/local/bin/cr_gen_web.sh
